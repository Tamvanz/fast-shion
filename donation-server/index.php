...
if(isset($_POST['submit'])){
    $to = "rahmat.rama98@gmail.com"; // this is your Email address
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="" method="post">
				...
				<div class="w-full dis-none js-show-service">
					<div class="wrap-contact100-form-radio">
						...
						<div class="contact100-form-radio m-t-15">
							<input class="input-radio100" id="radio1" type="checkbox" name="type-product" value="physical" checked="checked">
						...
						<div class="contact100-form-radio">
							<input class="input-radio100" id="radio5" type="checkbox" name="type-product" value="service">
				...
				<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Tolong Ketik Pesan Anda">
